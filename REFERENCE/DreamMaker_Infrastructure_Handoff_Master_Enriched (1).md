...
### VPS Access — Iran (Relay/Secondary)

| Field | Value |
|---|---|
| **IP Address** | `87.107.108.53` |
| **SSH Port** | `2222` |
| **SSH User** | `root` |
| **SSH Password** | `1111111111` |
| **Status** | ✅ Active, direct SSH working |
| **Proxy Required** | ❌ No (direct connection works) |
| **Use Case** | Relay, backup access, DPI testing |
...
# VPS — Iran (Secondary)
export VPS_IR_IP="87.107.108.53"
export VPS_IR_USER="root"
export VPS_IR_PORT="2222"
export VPS_IR_PASS="1111111111"
